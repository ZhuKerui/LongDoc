...
class RetrieveByBM25(Tool):
    def __init__(self):
        super().__init__(
            ...
            #### Returns:
            - `section_header` (str): The title or name of the section that is most closely matched to the query according to the BM25 ranking.
...
class RetrieveByDense(Tool):
    def __init__(self):
        super().__init__(
            ...
            #### Returns:
            - `section_header` (str): The title of the section that is ranked highest by the dense retrieval model based on semantic relevance to the query.
